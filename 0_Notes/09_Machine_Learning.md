...
{\scriptsize{Maximum Likelihood}} Klassification
\begin{itemize} 
...
\begin{tikzpicture}[scale=0.40, every node/.style={scale=0.5}]
  % Axes
...
{\scriptsize{Inconsistent Preprocessing}}
    \begin{itemize}
...
{\scriptsize{Resultate Interpretieren}}
