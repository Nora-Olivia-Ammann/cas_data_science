...
\begin{itemize}    
    ...
    \item LOESS Dekomposition: kontrolle über rolling window und period
\end{itemize}
...
\begin{itemize}
    ...
    \item[1] Durchschnitt (konstant): ich habe alle änderungen im trend drinn, an den residuen ändert sich nichts mehr. Wenn jetzt der Durchschnitt ändert, dann folgt jetzt einer anderen regel wie in der vergangenheit
    \item[2] Varianz (konstant): streuung muss konstant sein. Co-Varianz: zeitreihe zeitpunk T, verschiebung 4 lags, neuer Zeitpunkt verlgiech mit neuen lags. Wenn der zusammenhang besteht ist die varianz gleich
    \item[3] Saisonalität (keine): Ähnliche verteilung über der Zeit
