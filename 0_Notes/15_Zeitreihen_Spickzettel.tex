...
Green is 1 lag behind blue (at lag=1 green has value that blue has at lag=0)
Yellow (y is lag)
Kept blue static. Moved green in lags. Once - lag (expect strongest) and once + lag (weak correlation)
