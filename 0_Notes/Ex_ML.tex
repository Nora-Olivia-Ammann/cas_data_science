...
{\footnotesize{Linear Regression}} Supervised Regression
  \begin{itemize}
...
{\footnotesize{Logistic Regression}} Supervised Classification
  \begin{itemize}
...
{\footnotesize{K-Nearest Neighbours}} Supervised Classification
  \begin{itemize}
    \item \textbf{Beschreibung}
    \begin{itemize}
...
{\footnotesize{Support Vector Machine}} Supervised Classification
  \begin{itemize}
    \item \textbf{Beschreibung}
    \begin{itemize}
...
{\footnotesize{Decision Trees}} Supervised Classification
  \begin{itemize}
    \item \textbf{Beschreibung}
    \begin{itemize}
...
\hrule
\vspace{0.7em}
{\footnotesize{Clustering}} Unsupervised Classification
  \begin{itemize}
    \item \textbf{Beschreibung}
    \begin{itemize}
...
{\footnotesize{Principal Component Analysis}} Unsupervised Dimensionality Reduction
  \begin{itemize}
    \item \textbf{Beschreibung}
    \begin{itemize}
        \item 
...
{\footnotesize{Non-Negative Matrix Factorisation}} Unsupervised Dimensionality Reduction
  \begin{itemize}
    \item \textbf{Beschreibung}
    \begin{itemize}
        \item 
...
{\footnotesize{Auto Encoder}} Unsupervised Dimensionality Reduction
  \begin{itemize}
    \item \textbf{Beschreibung}
    \begin{itemize}
        \item 
...
{\footnotesize{Fully Connected Neural Network}} Typ: ???
  \begin{itemize}
    \item \textbf{Beschreibung}
    \begin{itemize}
        \item 
...
\vspace{0.4em}
{\footnotesize{Optimisation Algorithm}}
      \begin{itemize}
...
{\footnotesize{Metrik: Regression}}
\begin{itemize}
...
\vspace{0.4em}
{\footnotesize{Metrik: Klassifikation}}
...
{\footnotesize{Maximum Likelihood}}
\begin{itemize} 
...
{\normalsize{Feature Preprocessing}}
...
\vspace{0.4em}
{\footnotesize{Feature Selection}}
...
\vspace{0.4em}
{\footnotesize{Dimensionality Reduction}}
...
{\normalsize{Modell Komplexität}}

{\footnotesize{Overfitting vs. Underfitting}}
...
{\normalsize{Model Selection}}

{\footnotesize{Hyper Parameter}}
\begin{itemize}
...
\vspace{0.4em}
{\footnotesize{Algorithm Selection}}
