...
\begin{itemize}
    ...
    \begin{itemize}
        \item 
    \end{itemize}
    \item {\textbf{Entwicklung, Validierung, Betrieb}}
    \begin{itemize}
        \item 
    \end{itemize}
    \item {\textbf{MLOps v.s. DevOps}}
    \begin{itemize}
        \item 
    \end{itemize}
\end{itemize}
...
{\footnotesize{Worauf kommt’s an?}}

\begin{itemize}
    \item {\textbf{Modelle für den Betrieb bereitstellen}}
    \begin{itemize}
        \item 
    \end{itemize}
    \item {\textbf{Architektur von KI Systemen}}
    \begin{itemize}
        \item 
    \end{itemize}
    \item {\textbf{Drift-Monitoring und Massnahmen}}
    \begin{itemize}
        \item 
    \end{itemize}
\end{itemize}
...
{\footnotesize{Was ist sonst noch wichtig?}}

\begin{itemize}
    \item {\textbf{Produkte \& Services für MLOps, Kriterien}}
    \begin{itemize}
        \item 
    \end{itemize}
    \item {\textbf{Responsible AI und Governance}}
    \begin{itemize}
        \item 
    \end{itemize}
\end{itemize}
