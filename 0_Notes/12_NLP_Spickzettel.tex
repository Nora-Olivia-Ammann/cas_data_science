...
{\footnotesize{Binary Bag-of-Words}}
\begin{itemize}
  \item Representation: High-dim vector over vocab; 1 if word appears, else 0. Ignores order/frequency. No semantics
  \item When useful:
    \begin{itemize}
...
{\footnotesize{Dense (non-contextual) embeddings}}
\begin{itemize}
...
{\footnotesize{Contextualized transformer embeddings}}
\begin{itemize}
